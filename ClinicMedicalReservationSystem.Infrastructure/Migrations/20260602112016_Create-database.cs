    ...
    public partial class Createdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchDoctor", x => new { x.BranchesId, x.DoctorsId });
                    table.ForeignKey(
                        name: "FK_BranchDoctor_AspNetUsers_DoctorsId",
                        column: x => x.DoctorsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BranchDoctor_Branches_BranchesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Day = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NewStartingTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    NewEndingTime = table.Column<TimeOnly>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchDoctor_DoctorsId",
                table: "BranchDoctor",
                column: "DoctorsId");
